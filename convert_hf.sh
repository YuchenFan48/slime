...
PYTHONPATH=/apdcephfs/mnt/cephfs/users/yuchenfan/Megatron-LM python tools/convert_hf_to_torch_dist.py \
    ${MODEL_ARGS[@]} \
    --hf-checkpoint /apdcephfs/mnt/cephfs/users/yuchenfan/qwen-kda-olmo3/iter_0000000-hf \
    --save /apdcephfs/mnt/cephfs/users/yuchenfan/qwen-kda-olmo3/iter_0000000-hf-torch-dist 

...
cd /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/slime
...
CKPT_ARGS=(
   --hf-checkpoint /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/qwen-3-next-2B-A0.5B
   #--hf-checkpoint /apdcephfs/mnt/cephfs/users/yuchenfan/qwen-3-next-FP8
   --ref-load /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/qwen-3-next-2B-A0.5B-torch_dist
   --load /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/qwen-3-next-2B-A0.5B-pretrain-lr-std-mtp-True/
   --save /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/qwen-3-next-2B-A0.5B-pretrain-lr-std-mtp-True/
   --save-interval 4096
)
...
EVAL_ARGS=(
   --eval-interval 512
   --eval-prompt-data c4 /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/eval_data/c4.jsonl pes2o /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/eval_data/pes2o.jsonl pile /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/eval_data/pile.jsonl s2orc /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/eval_data/s2orc.jsonl
)

SFT_ARGS=(
   --rollout-function-path slime.rollout.sft_rollout.generate_rollout
   --prompt-data /mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/dolmo/processed_data
   --input-key text
   --rollout-shuffle
   --num-rollout 28000
...
OPTIMIZER_ARGS=(
   ...
   --lr-wsd-decay-iters 2500
   --lr-warmup-iters 2000
   --lr-decay-iters 28000
   --min-lr 0
   --adam-beta1 0.9
   --adam-beta2 0.98
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    \"PYTHONPATH\": \"/mnt/shared-storage-user/p1-shared/fanyuchen/pretrain/pretrain/Megatron-LM/\",

...
CKPT_ARGS=(
   --hf-checkpoint /apdcephfs/mnt/cephfs/users/yuchenfan/qwen-3-30B-A3B
   #--hf-checkpoint /apdcephfs/mnt/cephfs/users/yuchenfan/qwen-3-next-FP8
   --ref-load /apdcephfs/mnt/cephfs/users/yuchenfan/qwen-3-30B-A3B-torch_dist
   --load /apdcephfs/mnt/cephfs/users/yuchenfan/test/
   --save /apdcephfs/mnt/cephfs/users/yuchenfan/test/
   --save-interval 4096
)

...
CKPT_ARGS=(
   --hf-checkpoint /apdcephfs/mnt/cephfs/users/yuchenfan/deepseek-v3.2
   #--hf-checkpoint /apdcephfs/mnt/cephfs/users/yuchenfan/qwen-3-next-FP8
   --ref-load /apdcephfs/mnt/cephfs/users/yuchenfan/deepseek-v3.2-torch_dist
   --load /apdcephfs/mnt/cephfs/users/yuchenfan/dpsk-fixed/
   --save /apdcephfs/mnt/cephfs/users/yuchenfan/dpsk-fixed/
   --save-interval 4096
)
...
SFT_ARGS=(
   ...
   --prompt-data /apdcephfs/mnt/cephfs/users/yuchenfan/pretraining/train_data/allenai/dolma3_mix-6T-1025-sample-500B-sharded
   --input-key text
   --rollout-shuffle
   --num-rollout 100000
...
WANDB_ARGS=(
   --use-wandb
   --wandb-project slime-pretrain-deepseek

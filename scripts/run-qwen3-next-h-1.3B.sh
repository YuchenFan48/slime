...
source "${SCRIPT_DIR}/models/qwen3-next-1.3B-A0.4B.sh"
...
CKPT_ARGS=(
   --hf-checkpoint /mnt/shared-storage-user/p1-shared/yuchenzhang/qwen-3-next-1.3B-A0.4B
   --ref-load /mnt/shared-storage-user/p1-shared/yuchenzhang/qwen-3-next-1.3B-A0.4B-torch_dist
   --load /mnt/shared-storage-user/p1-shared/yuchenzhang/qwen-3-next-1.3B-A0.4B-pretrain-lr-std-loss-mask-yuchenzhang/
   --save /mnt/shared-storage-user/p1-shared/yuchenzhang/qwen-3-next-1.3B-A0.4B-pretrain-lr-std-loss-mask-yuchenzhang/
   --save-interval 4096
...
SFT_ARGS=(
   ...
   --prompt-data /mnt/shared-storage-user/p1-shared/yuchenzhang/dolmo/processed_data
   --input-key text
   --rollout-shuffle
   --num-rollout 100000

...
MODEL_ARGS=(
   ...
   --spec "slime_plugins.models.gpt_oss_infllmv2" "get_gpt_oss_infllmv2_spec"

   # Architecture: GptOssForCausalLM with InfLLM V2 sparse attention
   ...
   --infllmv2-topk-blocks 64      # Number of top-k blocks to select in Stage 1
   --infllmv2-block-size 64       # Block size for sparse attention (typically 64)
   --infllmv2-use-stage1 true     # Enable Stage 1 for top-k selection
